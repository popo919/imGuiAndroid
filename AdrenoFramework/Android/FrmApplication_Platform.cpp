...
BOOL CFrmAppContainer::InitializeEgl()
{
	...
	EGLint configAttribs[] = 
	{
		...
		EGL_RED_SIZE,			m_pApplication->m_nNumRedChannelBits,
		EGL_GREEN_SIZE,	    	m_pApplication->m_nNumGreenChannelBits,
		EGL_BLUE_SIZE,	    	m_pApplication->m_nNumBlueChannelBits,
		EGL_ALPHA_SIZE,			m_pApplication->m_nNumAlphaChannelBits,
		EGL_DEPTH_SIZE,			m_pApplication->m_nNumDepthBufferBits,
		EGL_STENCIL_SIZE,       m_pApplication->m_nNumStencilBufferBits,
#ifdef _OGLES3

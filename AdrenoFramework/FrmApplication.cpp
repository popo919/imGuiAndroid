                                           ...
                                           NativeDisplayType hDisplayType )
{
    ...
    { 
        ...
        EGL_RED_SIZE,		 m_nNumRedChannelBits,
        EGL_GREEN_SIZE,	     m_nNumGreenChannelBits,
        EGL_BLUE_SIZE,	     m_nNumBlueChannelBits,
        EGL_ALPHA_SIZE,	     m_nNumAlphaChannelBits,
        EGL_DEPTH_SIZE,	     m_nNumDepthBufferBits,
        EGL_STENCIL_SIZE,    m_nNumStencilBufferBits,
        EGL_SAMPLE_BUFFERS,  m_nNumMultiSampleBuffers,
        EGL_SAMPLES,		 m_nNumSamplesPerPixel,

...
namespace
{
    ...
    INT32 GetMemberOffset( const void* owner_address, const void* member_address )
    {
        INT32 owner_position  = (INT32)owner_address;
        INT32 member_position = (INT32)member_address;
        INT32 member_offset   = member_position - owner_position;
    ...
    {
        typedef UINT32 IntPointer; // TODO: replace UINT32 with a proper intptr that can handle 64-bit addresses
        ...
        for( int i = 0; i < pointer_table.NumPointers; ++i )
        {
            ...
            IntPointer* pointer = (IntPointer*)( data_buffer + pointer_fixup.PointerOffset );
            ...
            {
                IntPointer pointee = (IntPointer)( data_buffer + pointer_fixup.PointeeOffset );
                *pointer = pointee;
            }
        }
    }
